...
void myproject_float(
    ...
    float layer28_out[OUT_HEIGHT_26*OUT_WIDTH_26*N_FILT_26]
) {
    ...
    nnet::convert_data<result_t, float, OUT_HEIGHT_26*OUT_WIDTH_26*N_FILT_26>(layer28_out_ap, layer28_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer28_out[OUT_HEIGHT_26*OUT_WIDTH_26*N_FILT_26]
) {
    hls::stream<input_t> input_1_ap("input_1");
    ...
    nnet::convert_data<result_t, double, OUT_HEIGHT_26*OUT_WIDTH_26*N_FILT_26>(layer28_out_ap, layer28_out);
}
}
